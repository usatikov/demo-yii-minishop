<?php
/**
 * Base class for test cases about DB-related features
 *
 * Duplicates standard CDbTestCase, to extend our own TestCase class instead of CTestCase
 */
abstract class DbTestCase extends TestCase
{
    ...
    {
        if (is_array($this->fixtures) && isset($params[0])) {
            $record = $this->getFixtureManager()->getRecord($name, $params[0]);
            if ($record !== false) {
